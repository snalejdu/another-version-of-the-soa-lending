                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="mb-6">
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400">
                            Select accounts to generate statements of account
                        </p>
                    </div>
                    ...
                    <div class="mb-6 flex gap-4">
                        ...
                        <select
                            class="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md dark:bg-gray-700 dark:text-gray-200">
                                    ...
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                                            {{ $account->lastPaymentDate()
                                                ? \Carbon\Carbon::parse($account->lastPaymentDate())->format('M d, Y')
                                                : 'N/A' }}
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <a href="{{ route('soa.domShot', $account->id) }}"
                                                class="px-3 py-1 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800">
                                                Download Screenshot
                                            </a>
                                        </td>
                                    </tr>
