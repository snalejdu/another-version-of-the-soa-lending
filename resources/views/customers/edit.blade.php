                        ...
                        @if($customer->user)
                            <div class="mb-4 p-4 bg-blue-50 dark:bg-blue-900 rounded-md">
                                <p class="text-sm text-blue-800 dark:text-blue-200">
                                    <strong>Note:</strong> This customer has a user login account. Email changes will also update the login email.
                                </p>
                            </div>
                        @endif

                        <div class="flex items-center justify-end mt-6">
                            <a href="{{ route('customers.show', $customer) }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded mr-2">
                                Cancel
                            </a>
